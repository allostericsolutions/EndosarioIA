...
from bot.bot_utils import initialize_chat_state, simulate_greeting
from bot.chat_handler import handle_chat
...
if archivo_subido_1 and archivo_subido_2:
    ...
    handle_chat(selected_code, text_by_code_1, text_by_code_2)
