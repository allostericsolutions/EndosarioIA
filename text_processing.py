...
def extract_and_clean_text(pdf_path):
    ...
    patterns_to_remove = [
        ...
        r'A\s*GASTOS\s*CUBIERTOS\s*HONORARIOS\s*POR\s*CONSULTA\s*Y\s*PROCEDIMIENTOS\s*QUIRÚRGICOS',
        ...
        r'A\s*EXCLUSIONES\s*AMPLIACIÓN\s*COBERTURA\s*DE\s*S',
    ...
    return text_by_code, len(code_counts), list(code_counts), endoso_names
